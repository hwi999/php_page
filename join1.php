	...
	<meta charset="UTF-8">
      ...
      function check() {
       //myfrom 이름 설정
		...
		<form method="post" action="join_result.php" name="myform" onsubmit="return check()">
			<div class="container bcontent"><hr />
				<div class="card" style="width: 1200px;">
					<div class="row no-gutters">
						<div class="col-sm-5">
							<img class="card-img" src="image/img1.jpg" alt="뮤지컬 지킬앤하이드" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasExample" aria-controls="offcanvasExample">
								...
								<div class="form-floating mb-3">
									...
									<div class="form-floating mb-3">
										...
										<div class="form-floating mb-3">
											...
											<input type="hidden"  name="ticket" VALUE="a">
										</div>
